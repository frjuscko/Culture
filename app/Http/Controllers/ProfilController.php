...
class ProfilController extends Controller
{
    ...
    // Dans UserController ou SettingsController
    public function show2faSetup()
    {
        $secret = Auth::user()->enableTwoFactorAuth();
        $qrCode = Auth::user()->generateQrCode();

        return view('profile.2fa-setup', compact('qrCode', 'secret'));
    }
}
