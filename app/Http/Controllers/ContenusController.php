...
class ContenusController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pub', compact('regions', 'langues', 'types'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('contenus', compact('contenus', 'regions', 'langues', 'types', 'search'));
    }
    ...
    public function nonVal(){
        ...
        return view('contenus', compact('NVcontenus'));
    }
