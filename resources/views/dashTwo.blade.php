    ...
    <div class="interface">
        <div class="menu">
            @if (Auth::user()->isContributeur())
                <div class="pages">
                <ul>
                    <li><a href="/contributeur"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <li><a href="{{ route('mescontenus', Auth::user()->id) }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
            ...
            <div class="general">
                <ul>
                    <li><a href="{{ route('profil.show', Auth::user()->id) }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
