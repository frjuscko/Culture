    ...
    <div class="utilisateurs">
        ...
        @foreach ($users as $user)
            <div class="utilisateur" data-user-id="{{ $user->id }}" data-nom="{{ $user->nom }}"
                ...
                data-langue="{{ $user->langueinfo->nom ? $user->langueinfo->nom : 'Non spécifié' }}"
                data-region="{{ $user->regioninfo->nom }}" data-statut="{{ $user->statut }}"
                data-role="{{ $user->roleinfo->libelle }}" data-date="{{ $user->created_at->format('d M Y') }}"
                ...
                <div class="infos">
                    ...
                    <div class="info">
                        ...
                        <p class="details"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            </svg>{{ $user->regioninfo->nom }}</p>
                    </div>
                </div>

                <div class="statut">
                    <p class="fonction">{{ $user->roleinfo ? $user->roleinfo->libelle : 'Aucun rôle' }}</p>
