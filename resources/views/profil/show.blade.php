                ...
                @if(Auth::check() && Auth::id() == $user->id)
                    ...
                    @switch(Auth::user())
                        @case(Auth::user()->isAdmin())
                            <a href="/admin" class="btn-profil">Mon espace</a>
                            <a href="/" class="btn-profil">Accueil</a>
                            @break
                        @case(Auth::user()->isModerator())
                            <a href="/moderateur" class="btn-profil">Mon espace</a>
                            <a href="/" class="btn-profil">Accueil</a>
                            @break
                        @case(Auth::user()->isContributeur())
                            <a href="/contributeur" class="btn-profil">Mon espace</a>
                            <a href="/" class="btn-profil">Accueil</a>
                            @break
